...
export interface SchoolFormData {
  ...
  // Guru
  guru_sd_d3: number; guru_sd_s1: number; guru_sd_s2: number;
  guru_smp_d3: number; guru_smp_s1: number; guru_smp_s2: number;
  guru_sma_d3: number; guru_sma_s1: number; guru_sma_s2: number;
  guru_smk_d3: number; guru_smk_s1: number; guru_smk_s2: number;
  ...
  staf_sd_sma: number; staf_sd_d3: number; staf_sd_s1: number;
  staf_smp_sma: number; staf_smp_d3: number; staf_smp_s1: number;
  staf_sma_sma: number; staf_sma_d3: number; staf_sma_s1: number;
  staf_smk_sma: number; staf_smk_d3: number; staf_smk_s1: number;
...
// Fix: Omit 'type' from parent interfaces to prevent conflicting string literal definitions in FormData
